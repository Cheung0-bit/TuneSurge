...
访问网站，可以看到排名前十的作品，排名由点赞数，收藏数，评论质量等综合决定（需要设计排名的算法）。同时可预览新发布的MV，可以按照热度、发布时间分类分页浏览。主页有我的主页、历史记录选项，可以查看我的个人信息和浏览记录，也可以和别人进行私信。个人信息页面可以查看我的收藏，我的作品。可以发布作品。作品发布后需要接受审核，预发布。
...
![image-20230320184641056](C:/Users/zhanglin/AppData/Roaming/Typora/typora-user-images/image-20230320184641056.png)

当该用户权限列表不存在所要求的权限时，便会抛出异常

![image-20230320185133517](C:/Users/zhanglin/AppData/Roaming/Typora/typora-user-images/image-20230320185133517.png)

![image-20230320185214625](C:/Users/zhanglin/AppData/Roaming/Typora/typora-user-images/image-20230320185214625.png)

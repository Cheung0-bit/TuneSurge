...
//        clear_mp4(mp4folder_path+mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "C:\\Users\\zhanglin\\Desktop\\ffmpeg\\ffmpeg.exe";
        String video_path = "D:\\Upload\\对不起.avi";
        //转换后mp4文件的名称
        String mp4_name = "对不起.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\zhanglin\\Desktop\\对不起.mp4";
        //创建工具类对象
